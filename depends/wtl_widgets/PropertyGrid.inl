...
CPropertyGridImpl<T, TBase, TWinTraits>::CPropertyGridImpl() : 
      m_hwndInplace(NULL), 
      m_iInplaceRow(-1), 
      m_iInplaceCol(-1), 
      m_nColumns(0), 
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::SubclassWindow(HWND hWnd)
{
...
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::SetExtendedGridStyle(DWORD dwExtStyle)
{
...
template<class T, class TBase, class TWinTraits>
DWORD CPropertyGridImpl<T, TBase, TWinTraits>::GetExtendedGridStyle() const
{
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::SelectItem(int iRow, int iCol = 0)
{
...
template<class T, class TBase, class TWinTraits>
int CPropertyGridImpl<T, TBase, TWinTraits>::GetItemCount() const
{
...
template<class T, class TBase, class TWinTraits>
int CPropertyGridImpl<T, TBase, TWinTraits>::InsertItem(int nItem, HPROPERTY hProp)
{
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::SetSubItem(int nItem, int nSubItem, HPROPERTY hProp)
{
	ATLASSERT(::IsWindow(m_hWnd));
	ATLASSERT(hProp);
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::GetItemText(int iItem, int iSubItem, LPTSTR pstrText, UINT cchMax) const
{
	return GetItemText(GetProperty(iItem, iSubItem), pstrText, cchMax);
}

template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::GetItemText(HPROPERTY hProp, LPTSTR pstrText, UINT cchMax) const
{
	ATLASSERT(::IsWindow(m_hWnd));
	ATLASSERT(hProp);
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::GetItemValue(HPROPERTY hProp, VARIANT* pValue) const
{
	ATLASSERT(::IsWindow(m_hWnd));
	ATLASSERT(hProp);
	ATLASSERT(pValue);
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::SetItemValue(HPROPERTY hProp, VARIANT* pValue)
{
	ATLASSERT(::IsWindow(m_hWnd));
	ATLASSERT(hProp);
	ATLASSERT(pValue);
...
template<class T, class TBase, class TWinTraits>
int CPropertyGridImpl<T, TBase, TWinTraits>::GetSelectedColumn() const
{
	ATLASSERT(::IsWindow(m_hWnd));
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::DeleteColumn(int nCol)
{
	ATLASSERT(::IsWindow(m_hWnd));
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::GetColumnCount() const
{
	ATLASSERT(::IsWindow(m_hWnd));
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::FindProperty(IProperty* prop, int& iItem, int& iSubItem) const
{
...
template<class T, class TBase, class TWinTraits>
IProperty* CPropertyGridImpl<T, TBase, TWinTraits>::GetProperty(int iRow, int iCol) const
{
...
template<class T, class TBase, class TWinTraits>
LPARAM CPropertyGridImpl<T, TBase, TWinTraits>::GetItemData(HPROPERTY hProp) const
{
	ATLASSERT(::IsWindow(m_hWnd));
	ATLASSERT(hProp);
	if( hProp == NULL ) 
...
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::SetItemData(HPROPERTY hProp, LPARAM lParam)
{
	ATLASSERT(::IsWindow(m_hWnd));
	ATLASSERT(hProp);
	if( hProp == NULL ) 
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::GetItemEnabled(HPROPERTY hProp) const
{
	ATLASSERT(hProp);
	if( hProp == NULL )
		return FALSE;
...
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::SetItemEnabled(HPROPERTY hProp, BOOL bEnable)
{
	ATLASSERT(::IsWindow(m_hWnd));
	ATLASSERT(hProp);
	if( hProp == NULL ) 
...
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::Navigate(UINT wCode)
{
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::SetItem(int /*nItem*/, int /*nSubItem*/, UINT /*nMask*/, LPCTSTR /*lpszItem*/,
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::SetItemText(int /*nItem*/, int /*nSubItem*/, LPCTSTR /*lpszText*/)
{
	ATLASSERT(false);
	return FALSE;
}
...
template<class T, class TBase, class TWinTraits>
DWORD CPropertyGridImpl<T, TBase, TWinTraits>::SetViewType(DWORD /*dwType*/)
{
	ATLASSERT(false);
	return FALSE;
}
...
template<class T, class TBase, class TWinTraits>
CEdit CPropertyGridImpl<T, TBase, TWinTraits>::EditLabel(int /*nItem*/)
{
	ATLASSERT(false);
	return NULL;
}
...
// Implementation
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::_Init()
{
	ATLASSERT(::IsWindow(m_hWnd));
...
template<class T, class TBase, class TWinTraits>
BOOL CPropertyGridImpl<T, TBase, TWinTraits>::_SpawnInplaceWindow(IProperty* prop, int iItem, int iSubItem)
{
	ATLASSERT(prop);
	ATLASSERT(iItem!=-1);
...
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::_DestroyInplaceWindow()
{
...
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::_GetSubItemRect(int iItem, int iSubItem, RECT* pRect) const
{
...
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::_InvalidateItem(int iItem, int iSubItem)
{
...
template<class T, class TBase, class TWinTraits>
bool CPropertyGridImpl<T, TBase, TWinTraits>::_IsValidSelection() const
{
...
template<class T, class TBase, class TWinTraits>
bool CPropertyGridImpl<T, TBase, TWinTraits>::_IsAppendActionItem(int iItem) const
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnDestroy(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{      
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnFocus(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{      
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnScroll(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& bHandled)
{      
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnLButtonDown(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnKeyDown(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL& bHandled)
{      
	switch( wParam ) 
	{
		case VK_F2:
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnChar(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL& bHandled)
{      
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnGetDlgCode(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{      
	return DefWindowProc() | DLGC_WANTALLKEYS;
}

template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnSettingChange(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
	// Standard colors
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnSelChanged(int /*idCtrl*/, LPNMHDR pnmh, BOOL& bHandled)
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnDeleteItem(int /*idCtrl*/, LPNMHDR pnmh, BOOL& /*bHandled*/)
{
	ATLASSERT(m_nColumns>0);
	LPNMLISTVIEW pnmlv = (LPNMLISTVIEW) pnmh;      
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnNavigate(UINT /*uMsg*/, WPARAM wParam, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnUpdateProperty(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL& /*bHandled*/)
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnCancelProperty(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM lParam, BOOL& /*bHandled*/)
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnChangedProperty(UINT /*uMsg*/, WPARAM wParam, LPARAM lParam, BOOL& /*bHandled*/)
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnHeaderChanging(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& bHandled)
{
...
template<class T, class TBase, class TWinTraits>
LRESULT CPropertyGridImpl<T, TBase, TWinTraits>::OnHeaderDblClick(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
{
	// TODO
	return 0;
}
...
template<class T, class TBase, class TWinTraits>
DWORD CPropertyGridImpl<T, TBase, TWinTraits>::OnPrePaint(int /*idCtrl*/, LPNMCUSTOMDRAW /*lpNMCustomDraw*/)
{
	return CDRF_NOTIFYITEMDRAW;  // We need per-item notifications
}

template<class T, class TBase, class TWinTraits>
DWORD CPropertyGridImpl<T, TBase, TWinTraits>::OnItemPrePaint(int /*idCtrl*/, LPNMCUSTOMDRAW /*lpNMCustomDraw*/)
{
	return CDRF_NOTIFYSUBITEMDRAW;  // We need per-subitem notifications
}

template<class T, class TBase, class TWinTraits>
DWORD CPropertyGridImpl<T, TBase, TWinTraits>::OnSubItemPrePaint(int /*idCtrl*/, LPNMCUSTOMDRAW lpNMCustomDraw)
{
...
template<class T, class TBase, class TWinTraits>
void CPropertyGridImpl<T, TBase, TWinTraits>::DrawItem(CDCHandle dc, int iItem, int iSubItem, UINT iState)
{
